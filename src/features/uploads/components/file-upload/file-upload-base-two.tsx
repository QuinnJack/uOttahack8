      ...
      <div className="flex min-w-0 flex-1 flex-col items-start">
        <div className="flex w-full max-w-full min-w-0 flex-1">
          <div className="min-w-0 flex-1">
            <p className="truncate text-left text-sm font-bold text-secondary">
              {name}
            </p>
            ...
            <div className="mt-0.5 flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                {!isComplete && !failed && (
                  <Upload01 className="stroke-[2.5px size-4 text-fg-quaternary" />
                )}
                {!isComplete && !failed && (
          ...
          <ButtonUtility
            color="secondary"
            tooltip={
              metadataLoading ? "Finishing metadata extraction…" : "Continue"
            }
            icon={FlipForward}
            size="xs"
            className="mt-0 mr-2 self-start"
              ...
              {!failed && (
                <>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {!isComplete && (
                      <Upload01 className="size-4 stroke-[2.5px] text-fg-quaternary" />
                    )}
